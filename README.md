...
2026-07-29 的 V2-P0.5 数据接入治理工作包新增了数据库批次质量校验、
管理员审批和受控发布状态机。回归结果为后端 45/45、前端 3/3，PostgreSQL
迁移完成升级/降级/再升级，1600×900 页面无滚动与溢出。该结果仅表示工作包
通过，P0.5 的场景包抽离、不可变发布快照和完整指标迁移对账仍未完成。详见
