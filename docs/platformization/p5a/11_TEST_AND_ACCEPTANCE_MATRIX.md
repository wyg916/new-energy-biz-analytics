...
| 范围 | 结果 | 当前证据 |
|---|---:|---|
| PostgreSQL 后端全量 pytest | 359/359 effective PASS，0 failed，0 skipped；不声称一次单轮全绿 | `evidence/p5a-final-regression-summary.json`、`13_CURRENT_REGRESSION_CLOSEOUT.md` |
| Deterministic 固定评测 | 40/40 | `evidence/chatbi-eval-p5a-final.json` |
| 充电指标对账 | 15/15，差异 0 | `evidence/p5a-final-regression-summary.json` |
| 销售指标对账 | 12/12，差异 0 | `evidence/p5a-final-regression-summary.json` |
| Data Quality | 20/20 | `evidence/p5a-final-regression-summary.json` |
| Memory | 40/40 | `evidence/p5a-final-regression-summary.json` |
| Skill | 40/40 | `evidence/p5a-final-regression-summary.json` |
| RAG keyword-only | 60/60；Vector 未发布 | `evidence/p5a-final-regression-summary.json` |
| Response Composer | 7/7 | `evidence/p5a-final-regression-summary.json` |
| Query Security | 15/15 | `evidence/p5a-final-regression-summary.json` |
| SQLBot 离线聚焦 | 46/46 effective PASS；未声称外部运行时 | `evidence/p5a-final-regression-summary.json` |
...
| Playwright 原回归 | 23/23 | `evidence/playwright-original-23-p5a-final.xml` |
| Keycloak Authorization Code + PKCE | 3/3 | `evidence/playwright-p4-oidc-3-p5a-final.xml` |
| P5/P5A 精确 28 Gate UI | 1/1 | `evidence/playwright-p5-gate-1-p5a-contract-rerun.xml` |
| Playwright 合计 | 27/27 | `evidence/p5a-final-regression-summary.json` |
| Vitest | 首轮资源竞争 2/3；断言不变，重跑 3/3 | `evidence/vitest-p5a-final.xml`、`evidence/vitest-p5a-final-rerun.xml` |
| TypeScript / Vite build | PASS | `evidence/frontend-static-p5a-final.json` |
| npm audit | PASS，0 vulnerabilities | `evidence/npm-audit-p5a-final.json` |
